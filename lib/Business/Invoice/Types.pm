...
subtype Items, as 'Business::Invoice::Items';

coerce Items, from HashRef, via {
    coerce_items( Business::Invoice::Item->new($_) );
}, from 'Business::Invoice::Item', via {
    coerce_items($_);
}, from 'ArrayRef[Business::Invoice::Item]', via {
    coerce_items($_);
...
subtype Item, as 'Business::Invoice::Item';

subtype Recipient, as 'Business::Invoice::Recipient';

coerce Recipient, from HashRef, via {
    Business::Invoice::Recipient->new($_);
};

subtype Processor, as 'Business::Invoice::Processor';

coerce Processor, from Str, via {
